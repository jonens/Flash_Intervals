/* 
	FlashNotes Keyboard Notation View
	This class controls the browser output for the Notation area */

/* constructor */
Flash.Notes.Keyboard.NotationView = function (box_id, w, h) {
	this.PROPS = {
		numLines: 5,
		space: 14.0,
		ledgerLines: 1,		
...
Flash.Notes.Keyboard.NotationView.prototype.staffPath = function (){	
...
Flash.Notes.Keyboard.NotationView.prototype.clef = function (type, imgurl) {	
	var c = new Clef(this.STAFF_X, this.STAFF_Y, this.PROPS.space, type, imgurl);	
	return c;
}

Flash.Notes.Keyboard.NotationView.prototype.note = function (pos, staff) {
...
//add classes for accidentals and key signatures
Flash.Notes.Keyboard.NotationView.prototype.keySignature = function () {

}

Flash.Notes.Keyboard.NotationView.prototype.accidental = function () {

}

Flash.Notes.Keyboard.NotationView.prototype.ledgerLinePath = function (lines, note) {				
	var dir = 0;
