<?php
	...
	$query = "INSERT INTO intervals VALUES('','$score','$time','$date_string','$time_string')";
	$result = mysql_query($query, $con);
	$query = "SELECT score,time,date_string,time_string FROM intervals ORDER BY score DESC";
	$result = mysql_query($query, $con);
